class JBergen {
    ...
    onSwipe(direction) {
        switch (direction) {
        case "left":
            console.log("GO NEXT", window.siteData);
            if (window.siteData.nextURL) {
                window.location.href = window.siteData.nextURL;
            }
            break;
        case "right":
            console.log("GO PREV");
            if (window.siteData.prevURL) {
                window.location.href = window.siteData.prevURL;
            }
            break;
        }
    }
